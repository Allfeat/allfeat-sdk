...
//! - [`Isrc`] - International Standard Recording Code identifier
...
//!     track::{Track, Isrc, TrackTitle, TrackVersion},
//!     utils::Key,
//! };
...
//!     title: TrackTitle("Bohemian Rhapsody (Remastered)".to_string()),
//!     title_aliases: vec![],
...
use crate::benchmarking::{
    BenchmarkHelper, create_bounded_string, create_bounded_vec, create_optional_bounded_string
};
...
///     isrc: Isrc("GBUM71505079".to_string()),
...
///     title: TrackTitle("Hotel California (Live at MTV Unplugged)".to_string()),
///     title_aliases: vec![
///         TrackTitle("Hotel California - Unplugged".to_string())
///     ],
///     recording_year: Some(1994),
///     genres: vec![GenreId::Rock, GenreId::Acoustic],
...
/// International Standard Recording Code (ISRC) identifier for tracks.
///
/// The ISRC is a unique identifier for sound recordings and music videos,
/// following the format: `CCOOOYYNNNNN` where:
...
///
/// # Examples
/// - `USUM71703861` - US registrant, 2017, designation 03861
/// - `GBUM71505078` - GB registrant, 2015, designation 05078
/// - `FRXXX1234567` - French registrant example
///
/// # Type Transformation
...
/// # Usage
/// ```rust
/// # use allfeat_midds_v2::track::Isrc;
/// let isrc = Isrc("USUM71703861".to_string());
/// ```
#[runtime_midds]
pub struct Isrc(
...
/// // Basic title
/// let title1 = TrackTitle("Bohemian Rhapsody".to_string());
///
/// // Title with version info
/// let title2 = TrackTitle("Bohemian Rhapsody (Remastered 2011)".to_string());
///
/// // Title with featured artist
/// let title3 = TrackTitle("Empire State of Mind (feat. Alicia Keys)".to_string());
/// ```
#[runtime_midds]  
...
#[cfg(all(feature = "runtime", feature = "runtime-benchmarks"))]
impl BenchmarkHelper<Track> for Track {
    fn benchmark_instance(i: u32) -> Track {
        Track {
            isrc: Isrc(create_bounded_string::<12>(i)),
            musical_work: 1u64,
            artist: 2u64,
            ...
            title: TrackTitle(create_bounded_string::<256>(i)),
            title_aliases: create_bounded_vec::<TrackTitle, 16>(
                TrackTitle(create_bounded_string::<256>(1)), // Use minimal size for nested items
                i
            ),
